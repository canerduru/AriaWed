...
export const Auth: React.FC = () => {
  const { login, register, setUser, useApi } = useAuth();
  ...
  const validate = (): boolean => {
    ...
    if (!isLogin && !name.trim()) next.name = 'Name is required';
    setErrors(next);
    ...
    <div className="min-h-screen flex bg-white">
      <div className="hidden lg:flex w-1/2 bg-rose-50 relative overflow-hidden items-center justify-center">
        ...
        <div className="relative z-20 text-center text-white p-12 bg-black/30 backdrop-blur-sm rounded-3xl mx-12">
          ...
          <p className="text-lg text-white/90">Join thousands of couples and vendors on AriaWed.</p>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="max-w-md w-full space-y-8">
          ...
          {errors.form && (
            <div className="p-3 rounded-lg bg-rose-50 text-rose-700 text-sm">{errors.form}</div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-4">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-10 pr-4 py-3 bg-white border rounded-xl focus:outline-none focus:ring-2 focus:ring-rose-200 ${errors.name ? 'border-rose-400' : 'border-slate-200'}`}
                  />
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-10 pr-4 py-3 bg-white border rounded-xl focus:outline-none focus:ring-2 focus:ring-rose-200 ${errors.email ? 'border-rose-400' : 'border-slate-200'}`}
              />
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-10 pr-4 py-3 bg-white border rounded-xl focus:outline-none focus:ring-2 focus:ring-rose-200 ${errors.password ? 'border-rose-400' : 'border-slate-200'}`}
              />
